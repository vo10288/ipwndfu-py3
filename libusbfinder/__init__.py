...
import hashlib, os, platform, io, tarfile, sys
...
def libusb1_path_internal():
    ...
    # HACK to support macOS 10.15 and newer versions
    if version in ['10.15', '10.16', '11.0', '11.1', '11.2', '11.3', '11.4', '11.5', '11.6', '11.7', '12.0', '12.1', '12.2', '12.3', '12.4', '12.5', '12.6', '12.7', '13.0', '13.1', '13.2', '13.3', '13.4', '13.5', '13.6', '14.0', '14.1', '14.2', '14.3', '14.4', '14.5', '14.6', '15.0']:
        version = '10.14'
    if version == '':
    ...
    for config in configs:
        if version.startswith(config.version):
            ...
            with tarfile.open(fileobj=io.BytesIO(bottle)) as tar:
                for member in tar.getmembers():
                    if member.name.endswith(DYLIB_NAME):
                        dylib_data = tar.extractfile(member.name).read()
                        patched_dylib = apply_patches(dylib_data, config.dylib_patches)
